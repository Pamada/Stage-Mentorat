...
CREATE TABLE Users (
    ...
    expertise VARCHAR(255) DEFAULT NULL,             -- Field of expertise (null for mentorees)
...
CREATE TABLE Session (
    ...
    FOREIGN KEY (mentorID) REFERENCES Users(userID) ON DELETE CASCADE,  -- Relationship to Mentor
    FOREIGN KEY (mentoreeID) REFERENCES Users(userID) ON DELETE CASCADE -- Relationship to Mentoree
);
...
CREATE TABLE Communications (
    ...
    FOREIGN KEY (senderID) REFERENCES Users(userID) ON DELETE CASCADE,   -- Foreign key to Users for the sender
    FOREIGN KEY (receiverID) REFERENCES Users(userID) ON DELETE CASCADE  -- Foreign key to Users for the receiver
);
...
CREATE TABLE Contacts (
    ...
    FOREIGN KEY (userID1) REFERENCES Users(userID) ON DELETE CASCADE,  -- Foreign key to Users for the first user
    FOREIGN KEY (userID2) REFERENCES Users(userID) ON DELETE CASCADE   -- Foreign key to Users for the second user
);
...
VALUES
    (1, 'Coaching Meetup', '2024-10-22 10:00:00'),
    (2, 'Vue Meetup', '2024-10-28 15:00:00'),
